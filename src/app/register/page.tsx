...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col justify-center px-6 py-12 lg:px-8 bg-[#F8FAFC] dark:bg-slate-950 transition-colors duration-300">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p className="mt-2 text-center text-sm text-slate-500 dark:text-slate-400">
          Join TaskFlow today and start organizing
        </p>
      </div>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <div className="bg-white dark:bg-slate-900 py-8 px-10 shadow-sm border border-slate-200 dark:border-slate-800 rounded-3xl">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="email" className="block text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2">
                Email address
              </label>
              <input
                id="email"
