          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex items-end justify-between mb-8">
              ...
              <div className="flex gap-3">
                <div className="bg-white dark:bg-slate-900 px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-8 space-y-4">
                {tasks.length === 0 ? (
                  ...
                  tasks.map((task) => (
                    <div key={task.id} className="group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 flex items-center gap-4 hover:shadow-md dark:hover:shadow-indigo-900/10 hover:border-indigo-100 dark:hover:border-indigo-900 transition-all">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className={`font-bold text-slate-800 dark:text-slate-100 truncate ${task.status === "completed" ? "line-through text-slate-400 dark:text-slate-600" : ""}`}>
                          {task.title}
                        </h3>
              ...
              <div className="lg:col-span-4">
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm p-6 sticky top-8">
                  ...
                  <form action={createTask} className="space-y-4">
                    <div>
                      <label className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 block">Title</label>
                    ...
                    <div>
                      <label className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 block">List / Category</label>
                    ...
                    <div>
                      <label className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 block">Priority</label>
